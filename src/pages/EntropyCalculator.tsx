        ...
        <div className="max-w-3xl mx-auto">
              ...
              {entropy !== null && details && (
                <div className="space-y-4 mt-6">
                  <div className="text-center p-6 bg-slate-700 rounded-lg">
                    <div className="text-4xl font-bold text-cyan-400 mb-2">{entropy}</div>
                    <div className="text-white font-semibold">bits of entropy</div>
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 bg-slate-700 rounded-lg">
                      <div className="text-slate-300 text-sm">Password Length</div>
                      <div className="text-white font-bold text-xl">{details.length}</div>
                    </div>
                    <div className="p-4 bg-slate-700 rounded-lg">
                      <div className="text-slate-300 text-sm">Character Set Size</div>
                      <div className="text-white font-bold text-xl">{details.charSet}</div>
                    </div>
                  </div>

                  <div className="p-4 bg-slate-700 rounded-lg">
                    <h3 className="text-white font-semibold mb-3">Character Types Used:</h3>
                  ...
                  <div className="p-4 bg-slate-700 rounded-lg">
                    <h3 className="text-white font-semibold mb-2">Entropy Calculation:</h3>
                  ...
                  <div className="p-4 bg-slate-700 rounded-lg">
                    <h3 className="text-white font-semibold mb-2">Strength Assessment:</h3>
          ...
          <Card className="bg-slate-800/50 border-slate-700">
            <CardContent className="p-6">
              <h2 className="text-xl font-bold text-white mb-4">Understanding Entropy</h2>
